...
export function AppSidebar({ isOpen, setIsOpen }: SidebarProps) {
  return (
    <>
      ...
      {/* Toggle escritorio (se alinea al borde del sidebar) */}
      <Button
        variant="ghost"
        size="icon"
        className={cn(
          "fixed top-4 z-50 hidden lg:flex transition-all duration-300 bg-white shadow-md",
          ...
          <RSidebar className="w-64">
              ...
              <SidebarMenu>
                <SidebarMenuItem>
                  <div className="flex items-center gap-3 px-2 py-2">
                    {/* En Vite, assets del folder public se referencian como /archivo */}
                    <img
            ...
            <SidebarFooter>
              <SidebarMenu>
                <SidebarMenuItem>
                  <SidebarMenuButton asChild>
                    <button className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-900">
