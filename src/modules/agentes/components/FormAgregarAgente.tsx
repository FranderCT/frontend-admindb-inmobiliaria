...
import { initialValuesAgent } from "../types/agentTypes";
import { useCreateAgent } from "../hooks/agentesHooks";

const FormAgregarAgente = () => {
  ...
  const form = useForm({
    defaultValues: initialValuesAgent,
    onSubmit: async ({ value, formApi }) => {
      setFormErrors({});
      setFormError(null);

      try {
        await create.mutateAsync({ agent: value });
        formApi.reset();
        setOpen(false);
...
export default FormAgregarAgente;
