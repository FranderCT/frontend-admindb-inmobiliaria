...
const FormEditAgente = ({
  ...
  const form = useForm({
    defaultValues: {
      identificacion: String(agente.identificacion),
      nombre: agente.nombre ?? "",
      apellido1: agente.apellido1 ?? "",
      apellido2: agente.apellido2 ?? "",
      telefono: agente.telefono ?? "",
      estado: agente.estado ? 1 : 0,
    },
  ...
  useEffect(() => {
    if (open) {
      form.setFieldValue("identificacion", String(agente.identificacion));
      form.setFieldValue("nombre", agente.nombre ?? "");
      form.setFieldValue("apellido1", agente.apellido1 ?? "");
      form.setFieldValue("apellido2", agente.apellido2 ?? "");
      form.setFieldValue("telefono", agente.telefono ?? "");
      form.setFieldValue("estado", agente.estado ? 1 : 0);
      setFormErrors({});
      setFormError(null);
    }
  }, [open, agente]);
